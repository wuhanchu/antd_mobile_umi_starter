...
describe("test CheckPermissions", () => {
    ...
    it("Wrong string permission authentication", () => {
        expect(checkPermissions("admin", "user", target, error)).toEqual(
            "error"
        )
    })
    it("Correct Array permission authentication", () => {
        expect(
            checkPermissions(["user", "admin"], "user", target, error)
        ).toEqual("ok")
    })
    ...
    it("Wrong Array permission authentication", () => {
        expect(
            checkPermissions(["user", "admin"], "guest", target, error)
        ).toEqual("error")
    })
    ...
    it("Correct Function permission authentication", () => {
        expect(checkPermissions(() => true, "guest", target, error)).toEqual(
            "ok"
        )
    })
    ...
    it("authority is string, currentAuthority is array, return ok", () => {
        expect(
            checkPermissions("user", ["user", "admin"], target, error)
        ).toEqual("ok")
    })
    ...
    it("Correct Function permission authentication", () => {
        expect(checkPermissions(() => true, ["user"], target, error)).toEqual(
            "ok"
        )
    })
    it("authority is undefined , return ok", () => {
