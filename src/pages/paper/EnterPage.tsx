...
class EnterPage extends React.Component<IProps, IState> {
    ...
    public render(): React.ReactNode {
        ...
        return (
            ...
            >
                {successMsg && (
                    <div className={styles["alert-box"]}>{successMsg}</div>
                )}
                {errorMsg && (
                    <div
                        ...
                        <div className={styles["item-label"]}>
                            ...
                            >
                                ...
                                >
                                    ...
                                    />
                                    <span
                                        className={styles["checkbox-inner"]}
                                    />
                                </span>
                                我同意参与试驾
                            </label>
    ...
    private getResultData = () => {
        ...
        const obj = resultData.filter(
            item => item.minScore <= score && item.maxScore >= score
        )[0] || {
            info: []
        }
        let data = {}
    ...
    private handleSubmit = () => {
        ...
        if (
            !new RegExp(
                "^0?(13[0-9]|14[579]|15[0-35-9]|16[6]|17[0135678]|18[0-9]|19[89])\\d{8}$"
            ).test(phone)
        ) {
